    ...
    <div class="dialog-div" style="margin-top: 5px">
      <table class="dialog-content">
        ...
        <tr>
          ...
          <td colspan="1">
            <input type="checkbox" v-model="roleAdmin" />管理员
            <input type="checkbox" v-model="roleStudent" />学生
            <input type="checkbox" v-model="roleTeacher" />教师
          </td>
        </tr>
        <tr>
          <td colspan="2">
