        ...
        <div class="col-8">
          <nav class="navbar bg-body-tertiary">
            <div class="container-fluid">
              <a class="navbar-brand" href="/UserList">
                用户列表
              </a>
...
import { getStudentList, getTeacherList } from "~/services/personServ";
import { getPersonInfo, getAvatar } from "~/services/blogServ";
...
export default defineComponent({
  ...
  methods: {
    async search() {
      this.studentList = await getStudentList(this.searchContent);
      this.teacherList = await getTeacherList(this.searchContent);
      this.userList = [...this.studentList, ...this.teacherList];
      this.getUserAvatar();
    },
